...
# use-case it to import csv and add hashes to globalsafelist

import pandas as pd

#modify filename as needed
df = pd.read_csv("Safe_20201203.csv")
...
for index, row in df.iterrows():
    ...
    API.add_to_global_list("safe", "import from old tenant", row["SHA256 Hash"], category="None")
